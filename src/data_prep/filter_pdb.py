...
csv_files = glob.glob("../../data/ligand_PDBs/validation_dataset_w_values/*_cport_ready.csv")
...
for file in csv_files:
    ...
    above_df.to_csv(f"../../data/ligand_PDBs/validation_dataset_w_values/above_treshold/{acc_code}.csv")
    below_df.to_csv(f"../../data/ligand_PDBs/validation_dataset_w_values/below_treshold/{acc_code}.csv")
...
main_above_df.to_csv(f"../../data/ligand_PDBs/validation_dataset_w_values/above_treshold/above_master.csv")
main_below_df.to_csv(f"../../data/ligand_PDBs/validation_dataset_w_values/below_treshold/below_master.csv")
